...
<header class="header">
    ...
    <a href="#" class="logo"> <span>ABC</span>Motors </a>
...
<div class="login-form-container">
    ...
    <form action="" method="POST">
        <h3>user login</h3>
        <input type="text" placeholder="uesr name" name="username" id="username" class="box">
...
<section class="contact" id="contact">
    ...
    <div class="row">
        ...
        <form action="contact.php" method="POST">
            <h3>get in touch</h3>
            <input type="text" name="your_name" placeholder="your name" class="box">
            <input type="email" name="your_email" placeholder="your email" class="box">
            <input type="tel" name="your_phone" placeholder="Mobile" class="box">
            <textarea placeholder="your message" name="comments" class="box" cols="30" rows="10"></textarea>
...
<section class="footer" id="footer">
    ...
    <div class="box-container">
        ...
        <div class="box">
            ...
            <a href="#"> <i class="fas fa-map-marker-alt"></i> xyz, india - 999 999 </a>
        </div>
